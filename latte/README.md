...
- latte-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- latte-ui: main application module, development time
- latte-production: module that produces a production mode WAR for deployment
